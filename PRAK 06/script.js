const apiKey = "f6e883467a204537a8d43634241510"; // API key yang Anda dapatkan
const city = "Ciracas";
...
fetch(apiURL)
  ...
  .catch((error) => {
    ...
    document.getElementById("current-weather").innerHTML =
      "<p>Terjadi kesalahan saat mengambil data cuaca.</p>";
    document.getElementById("weather-forecast").innerHTML =
      "<p>Ramalan cuaca tidak dapat ditampilkan.</p>";
  });
